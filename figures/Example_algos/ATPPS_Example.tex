\begin{tikzpicture}[scale=0.75, thick, main node/.style={circle, draw, minimum size=1.2cm}]
    ...
    \node[above, color=blue] at (-1,6) {$RN_{A,0}=\{B,C\}$};
    \node[above, color=blue] at (3,6) {$RN_{B,0}=\{A,C\}$};
    \node[above, color=blue] at (-1,-2.2) {$RN_{C,0}=\{A,B\}$};
    \node[above, color=blue] at (3,-2.2) {$RN_{D,0}=\{A,B\}$};

     \node[above, color=blue] at (7.5,6) {$R_{A,0}=\{A, B, C, D\}$};
    \node[above, color=blue] at (11.5,6) {$R_{B,0}=\{A, B\}$};
    \node[above, color=blue] at (7.5,-2.2) {$R_{C,0}=\{\}$};
